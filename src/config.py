...
# ================================================================================
ROOT_ARTIFACT_DIR = os.path.expanduser("~/orthrus_artifacts/") # Destination folder for generated files. Will be created if doesn't exist.
...
DATABASE_DEFAULT_CONFIG = {
     "host": "localhost",
     "user": "postgres",
     "password": "",  # If you set a password for postgres, put it here
     "port": "5432",
}
# ================================================================================
